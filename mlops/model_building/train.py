...
Xtrain_path = "hf://datasets/shajinmajeed/Bank-customer-churn-16/Xtrain.csv"
Xtest_path = "hf://datasets/shajinmajeed/Bank-customer-churn-16/Xtest.csv"
ytrain_path = "hf://datasets/shajinmajeed/Bank-customer-churn-16/ytrain.csv"
ytest_path = "hf://datasets/shajinmajeed/Bank-customer-churn-16/ytest.csv"
...
xgb_model1 = xgb.XGBClassifier(scale_pos_weight=class_weight, random_state=42)
...
repo_id = "shajinmajeed/churn-model"
repo_type = "model"
